...
def evaluate_shadow_admission(manifest: Mapping, rows: Iterable[Mapping]) -> dict:
    ...
    return {
        ...
        "errors": errors,
        "integrity": {
            "requires_both_causal_and_postfreeze_checks": True,
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Unified causal + post-freeze admission gate for prospective shadow rows")

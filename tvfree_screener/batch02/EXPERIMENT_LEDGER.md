...
## CORE-ALL-MARKET-STATE-20260913-01 — discovery frozen; 2024 confirmation gated
...
- The discovery report records `2024_outcome_values_opened=false` and `2025_plus_features_or_outcomes_opened=false`. Do not inspect 2024 until the reports, feature freeze, control state, and this ledger update are committed. If 2024 fails, reject this feature family without replacement search. Fundamental V2 handoff remains absent from this checkout; continue independently.

...
| Supervisor coordination / dashboard | 🟢 **常時稼働** | **93%** | 07:01横断scanで全lane dedupe、Consensusのdashboard-only HEADを吸収し、外部待機laneのworker浪費防止ルールをSTATEへ明示 |

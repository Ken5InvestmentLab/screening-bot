...
- Next: commit these feature-only pool hashes and receipt, then run only the registered, separately purged 2022H2/2023 discovery. If features freeze, commit that freeze before opening 2024 outcomes. Fundamental V2 handoff remains absent in this checkout; check again after discovery.

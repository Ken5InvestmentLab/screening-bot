...
FAMILY_SPEC = {
    "experiment_id": "CORE-RIDGE-20260913-03",
    ...
    "known_evidence_limit": "RETROSPECTIVE_PROVISIONAL; the underlying historical OHLCV and research periods have prior exposure outside this experiment. Dataset is not proven point-in-time TSE membership, adjusted for all corporate actions, or executable at open/price limits.",
}

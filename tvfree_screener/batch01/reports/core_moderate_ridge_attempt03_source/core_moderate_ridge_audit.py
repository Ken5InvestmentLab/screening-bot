...
FROZEN_SPEC_PATH = REPORT_DIR / "core_moderate_ridge_spec_v3.json"
POLICY_LOCK_PATH = REPORT_DIR / "core_moderate_ridge_discovery_policy_lock_v3.json"
DISCOVERY_REPORT = REPORT_DIR / "core_moderate_ridge_v3_discovery.json"
VALIDATION_REPORT = REPORT_DIR / "core_moderate_ridge_v3_validation_2024.json"
...
def _feature_panel(through: pd.Timestamp, calendar: SessionCalendar) -> pd.DataFrame:
    panel_path = BATCH_DIR / ".cache" / f"core_moderate_v3_features_through_{through.year}.parquet"
